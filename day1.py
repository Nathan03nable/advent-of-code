    ...
    for input in input_array:
        ...
        for char in input:
            if char.isdigit():
                last_number = char
                if number_counter == 0:
                    outputted_number += last_number
                number_counter = number_counter + 1
        outputted_number += last_number
        whole_sum += int(outputted_number)
    print(whole_sum)


def translate_nums(line: str):
    line = line.replace("one", "one1e")
    line = line.replace("two", "two2o")
    line = line.replace("three", "three3e")
    line = line.replace("four", "four4r")
    line = line.replace("five", "five5e")
    line = line.replace("six", "six6x")
    line = line.replace("seven", "seven7n")
    line = line.replace("eight", "eight8t")
    line = line.replace("nine", "nine9e")
...
if __name__ == '__main__':
    find_nums()
    # nums = translate_nums("twothreefour")
    # print(nums)
